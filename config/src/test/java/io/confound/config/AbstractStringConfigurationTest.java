...
public class AbstractStringConfigurationTest {
	...
	public void testGetOptionalObject() {
		...
		when(configuration.getOptionalStringImpl("foo")).thenReturn(Optional.of("abc123"));
	...
	public void testGetOptionalDouble() {
		final AbstractStringConfiguration configuration = mock(AbstractStringConfiguration.class, CALLS_REAL_METHODS);
		when(configuration.getOptionalStringImpl("foo")).thenReturn(Optional.of("1.23"));
	...
	public void testGetOptionalInt() {
		final AbstractStringConfiguration configuration = mock(AbstractStringConfiguration.class, CALLS_REAL_METHODS);
		when(configuration.getOptionalStringImpl("foo")).thenReturn(Optional.of("123"));
	...
	public void testGetOptionalLong() {
		final AbstractStringConfiguration configuration = mock(AbstractStringConfiguration.class, CALLS_REAL_METHODS);
		when(configuration.getOptionalStringImpl("foo")).thenReturn(Optional.of("123456789"));
	...
	public void testGetOptionalPath() {
		...
		final AbstractStringConfiguration configuration = mock(AbstractStringConfiguration.class, CALLS_REAL_METHODS);
		when(configuration.getOptionalStringImpl("foo")).thenReturn(Optional.of(userFooBarPath.toString()));
	...
	public void testGetOptionalString() {
		final AbstractStringConfiguration configuration = mock(AbstractStringConfiguration.class, CALLS_REAL_METHODS);
		when(configuration.getOptionalStringImpl("foo")).thenReturn(Optional.of("bar"));
	...
	public void testGetOptionalUri() {
		final AbstractStringConfiguration configuration = mock(AbstractStringConfiguration.class, CALLS_REAL_METHODS);
		when(configuration.getOptionalStringImpl("foo")).thenReturn(Optional.of("http://example.com/bar"));
