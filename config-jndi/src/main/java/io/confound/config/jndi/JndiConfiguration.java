...
public class JndiConfiguration extends AbstractStringConfiguration {
	...
	/**
	 * Constructor of the JNDI Configuration without any fallback parent configuration or JNDI environment properties.
	...
	/**
	 * Constructor of the JNDI Configuration providing a fallback parent configuration but no JNDI environment properties.
	 * @param parentConfiguration The fallback parent configuration.
	 * @throws NamingException If an error occur while creating an initial JNDI context.
	 */
	public JndiConfiguration(@Nullable final Configuration parentConfiguration) throws NamingException {
	...
	/**
	 * Constructor of the JNDI Configuration using a fallback parent configuration and providing JNDI environment properties.
	 * 
	 * @param parentConfiguration The fallback parent configuration.
	 * @param environment The JNDI environment properties to be used.
	 * @throws NamingException If an error occur while creating an initial JNDI context.
	 */
	public JndiConfiguration(@Nullable final Configuration parentConfiguration, @Nullable Hashtable<String, String> environment) throws NamingException {
